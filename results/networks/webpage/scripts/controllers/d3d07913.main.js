...
angular.module('cyViewerApp')
    .controller('MainCtrl', function($scope, $http, $location, $routeParams, $window, Network, VisualStyles) {
            ...
            $scope.currentNetworkData = Network.get({ filename: $scope.networks[defaultNetworkName] },
                function() {
            ...
            var options = {
                ...
                ready: function() {
                    ...
                    VisualStyles.query({ filename: visualStyleFile }, function(vs) {
                        init(vs);
                        dropSupport();
                        setEventListeners();
            ...
            $scope.switchNetwork = function() {
                ...
                networkData = Network.get({ filename: networkFile },
                    function(network) {
                        $scope.cy.load(network.elements);
                        $scope.currentNetworkData = networkData;
                        reset();
